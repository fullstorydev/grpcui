...
var webFormTemplate = template.Must(template.New("grpc web form").Parse(string(webform.MustAsset("webform-template.html"))))
...
func WebFormScript() []byte {
	return webform.MustAsset("webform.js")
}
...
func WebFormSampleCSS() []byte {
	return webform.MustAsset("webform-sample.css")
}
